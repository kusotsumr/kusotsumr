 ...
 */
public class ReplaceIfGreaterThanMusicBandCommand implements Request<ReplaceIfGreaterThanMusicBandCommandResponse> {
    private final String key;
    private final MusicBand musicBand;

    @JsonCreator
    public ReplaceIfGreaterThanMusicBandCommand(@JsonProperty("key")String key, @JsonProperty("musicBand")MusicBand musicBand) {
